(function() {
  ...
  const ColorPickerPanel = ({ onClose, anchorRect }) => {
    ...
    const renderColorBox = (hex, index) => /* @__PURE__ */ window.React.createElement(
      "button",
      {
        key: `${hex}-${index}`,
    ...
    return /* @__PURE__ */ window.React.createElement(
      ...
      /* @__PURE__ */ window.React.createElement("div", { className: "flex justify-between items-center mb-4" }, /* @__PURE__ */ window.React.createElement("span", { className: "text-[10px] uppercase tracking-wider text-slate-500 font-bold ml-1 drag-region w-full" }, t("colorPicker")), /* @__PURE__ */ window.React.createElement("div", { className: "flex gap-1" }, /* @__PURE__ */ window.React.createElement(
        "button",
        {
        ...
        /* @__PURE__ */ window.React.createElement("span", { className: "material-symbols-outlined text-[16px]" }, "colorize")
      ...
      /* @__PURE__ */ window.React.createElement("div", { className: "flex bg-black/20 p-1 rounded-lg mb-4" }, /* @__PURE__ */ window.React.createElement(
        "button",
        {
          onClick: () => {
            setActiveTab("wheel");
      ...
      activeTab === "wheel" ? /* @__PURE__ */ window.React.createElement("div", { className: "flex flex-col gap-4" }, /* @__PURE__ */ window.React.createElement("div", { className: "flex flex-col items-center" }, /* @__PURE__ */ window.React.createElement(
        "div",
        {
          ref: satRectRef,
        ...
        /* @__PURE__ */ window.React.createElement("div", { className: "absolute inset-0 bg-gradient-to-r from-white to-transparent" }),
        /* @__PURE__ */ window.React.createElement("div", { className: "absolute inset-0 bg-gradient-to-t from-black to-transparent" }),
        /* @__PURE__ */ window.React.createElement(
          "div",
          {
      ...
      ), /* @__PURE__ */ window.React.createElement("div", { className: "flex items-center gap-3 w-full mt-4" }, /* @__PURE__ */ window.React.createElement(
        "div",
        {
          className: "w-10 h-10 rounded-full border-2 shadow-sm",
          style: { backgroundColor: currentColor, borderColor: "var(--theme-border)" }
        }
      ), /* @__PURE__ */ window.React.createElement("div", { className: "flex-1 flex flex-col gap-1" }, /* @__PURE__ */ window.React.createElement("div", { className: "flex bg-black/30 rounded-lg p-0.5" }, /* @__PURE__ */ window.React.createElement("div", { className: "flex-1 py-1 text-[10px] text-center font-bold text-primary bg-primary/10 rounded-md" }, "HEX"), /* @__PURE__ */ window.React.createElement("div", { className: "flex-1 py-1 text-[10px] text-center font-bold text-slate-500 rounded-md" }, "RGB")), /* @__PURE__ */ window.React.createElement(
        "input",
        {
          type: "text",
      ...
      )))), /* @__PURE__ */ window.React.createElement("div", { className: "h-[1px] w-full bg-slate-700/50 my-1" }), /* @__PURE__ */ window.React.createElement("div", { className: "h-64 overflow-y-auto pr-2 custom-scrollbar flex flex-col gap-4" }, harmonies.map((harmony, i) => /* @__PURE__ */ window.React.createElement("div", { key: i }, /* @__PURE__ */ window.React.createElement("div", { className: "flex justify-between items-end mb-1" }, /* @__PURE__ */ window.React.createElement("span", { className: "text-xs text-slate-400" }, harmony.name), /* @__PURE__ */ window.React.createElement(
        "button",
        {
        ...
        t("copyAll")
      )), /* @__PURE__ */ window.React.createElement("div", { className: "flex gap-1" }, harmony.colors.map((hex, idx) => renderColorBox(hex, idx))))))) : /* @__PURE__ */ window.React.createElement("div", { className: "flex flex-col gap-3 h-80 overflow-y-auto pr-2 custom-scrollbar" }, /* @__PURE__ */ window.React.createElement(
        "button",
        {
        ...
        /* @__PURE__ */ window.React.createElement("span", { className: "material-symbols-outlined text-sm" }, "add"),
        t("createNewPalette")
      ), colorPalettes.length === 0 ? /* @__PURE__ */ window.React.createElement("div", { className: "text-center text-slate-500 text-sm mt-8" }, t("noPalettes")) : colorPalettes.map((palette) => /* @__PURE__ */ window.React.createElement("div", { key: palette.id, className: "bg-black/20 rounded-lg p-2 border", style: { borderColor: "var(--theme-border)" } }, /* @__PURE__ */ window.React.createElement("div", { className: "flex justify-between items-center mb-2" }, /* @__PURE__ */ window.React.createElement(
        "input",
        {
          type: "text",
      ...
      ), /* @__PURE__ */ window.React.createElement("div", { className: "flex gap-1" }, /* @__PURE__ */ window.React.createElement("button", { onClick: () => duplicatePalette(palette.id), className: "w-5 h-5 flex items-center justify-center text-slate-400 hover:text-white bg-white/5 rounded" }, /* @__PURE__ */ window.React.createElement("span", { className: "material-symbols-outlined text-[13px]" }, "content_copy")), /* @__PURE__ */ window.React.createElement("button", { onClick: () => deletePalette(palette.id), className: "w-5 h-5 flex items-center justify-center text-red-500 hover:text-red-400 bg-red-500/10 rounded" }, /* @__PURE__ */ window.React.createElement("span", { className: "material-symbols-outlined text-[13px]" }, "delete")))), /* @__PURE__ */ window.React.createElement("div", { className: "flex gap-1" }, palette.colors.map((hex, index) => /* @__PURE__ */ window.React.createElement("div", { key: index, className: "flex flex-col gap-1 flex-1" }, /* @__PURE__ */ window.React.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ window.React.createElement("div", { className: "absolute inset-0 bg-white/0 group-hover:bg-white/10 transition-colors flex items-center justify-center" }, /* @__PURE__ */ window.React.createElement("span", { className: "material-symbols-outlined text-white opacity-0 group-hover:opacity-100 text-sm transition-opacity" }, "edit"))
      ), /* @__PURE__ */ window.React.createElement(
        "input",
        {
          type: "text",
