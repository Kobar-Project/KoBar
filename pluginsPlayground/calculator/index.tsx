...
const CalculatorPluginPanel = ({ onClose, anchorRect }: any) => {
            ...
            {mode === 'currency' ? (
                <div className="flex-1 flex flex-col">
                            ...
                            <div className="flex items-center gap-1.5 no-drag-region">
                                <button
                                    onClick={() => {
                                        ...
                                        (window as any).api?.writeToClipboard?.({ type: 'text', content: cleanVal });
                    ...
                    <div className="grid grid-cols-4 gap-2">
                        ...
                        <CalcButton onClick={handleSwapCurrencies} className="bg-primary text-slate-900 hover:opacity-90 font-bold" title={t('swapCurrencies')}>{t('swap')}</CalcButton>
                    </div>
                </div>
            ) : (
                <>
