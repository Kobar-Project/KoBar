...
const TodoListPanel = (props) => {
    ...
    return (
        <div
            ...
            style={getPopupStyle()}
        >
            <div className="flex justify-between items-center p-4 pb-3 relative">
                <span className="text-[10px] uppercase tracking-wider text-slate-500 font-bold ml-1 drag-region w-full">{t('todoListHeader')}</span>
                
                <span className="absolute left-1/2 -translate-x-1/2 text-[10px] text-slate-400 font-bold tracking-wider pointer-events-none">
